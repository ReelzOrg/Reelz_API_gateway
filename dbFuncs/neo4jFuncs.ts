...
const neo4jUri: string = String(process.env.NEO4J_URI) || "";
const neo4jUsername: string = String(process.env.NEO4J_USERNAME) || "";
const neo4jPassword: string = String(process.env.NEO4J_PASSWORD) || "";
